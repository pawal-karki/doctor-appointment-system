        ...
        <div class="admin-content">
            ...
            <div class="content-container">
                <div class="card">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/departments" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <c:if test="${not empty department.imageUrl}">
                                <div class="current-image">
                                    <p>Current Image:</p>
                                    <img src="${pageContext.request.contextPath}/${department.imageUrl}" alt="Current Department Image">
                                </div>
                            </c:if>
                        </div>
